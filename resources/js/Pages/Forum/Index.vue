...
<template>
    <AppHead pageTitle="Discuss" description="Here, You can discuss with the wonderfull people of Vestora."
                    ...
                    <div class="mb-3 row thread" v-for="post in posts.data">
                        ...
                        <div class="gap-2 align-middle flex-container">
                            <a :href="route('user.profile', { username: post.username })">
                                <img src="https://c0.ptacdn.com/thumbnails/avatars/5776010ff283fef420d0c1bad8801a52c1f911ad7b5e07ae7cbb9c4918b93d74-icon.png"
