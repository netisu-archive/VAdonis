    ...
    <Sidebar>
        <div class="cell small-12">
            ...
            <div class="grid-x align-center">
                <div class="mb-3 row card avatar card-body mx-2" v-for="user in users.data" :key="users.id">
                    <div class="gap-2 align-middle flex-container">
                        <Link :href="route('user.profile', { username: user.username })">
                        <img src="/assets/img/dummy_headshot.png" style="max-width:65px"
